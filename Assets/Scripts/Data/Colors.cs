...
public static class Colors
{
    ...
    public static readonly Color Green = new Color32(0x27, 0xAE, 0x60, 0xFF); // #27AE60
    public static readonly Color GreenVivid = new Color32(0x34, 0xC7, 0x59, 0xFF); // #34C759  (더 또렷함, 약간 노란기)
