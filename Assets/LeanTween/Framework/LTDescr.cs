...
* <br>
* Retrieve a <strong>unique playerId</strong> for the tween by using the "playerId" property. You can pass this to LeanTween.pause, LeanTween.resume, LeanTween.cancel, LeanTween.isTweening methods<br>
* <br>
* &nbsp;&nbsp;<h4>Example:</h4>
...
public class LTDescr
{
	...
	public override string ToString(){
		return (trans!=null ? "name:"+trans.gameObject.name : "gameObject:null")+" toggle:"+toggle+" passed:"+passed+" time:"+time+" delay:"+delay+" direction:"+direction+" from:"+from+" to:"+to+" diff:"+diff+" type:"+type+" ease:"+easeType+" useEstimatedTime:"+useEstimatedTime+" playerId:"+id+" hasInitiliazed:"+hasInitiliazed;
	}
	...
	[System.Obsolete("Use 'LeanTween.cancel( playerId )' instead")]
	public LTDescr cancel( GameObject gameObject ){
		// Debug.Log("canceling playerId:"+this._id+" this.uniqueId:"+this.uniqueId+" go:"+this.trans.gameObject);
...
//		val = (val * val * val * val - 2f);
	...
	* @return {LTDescr} LTDescr an object that distinguishes the tween
	* @example
	* int tweenId = LeanTween.moveX(gameObject, 5f, 2.0f ).playerId;<br>
	* // Later<br>
