...
Common
1. Common: 치명타 확률 +10%.
2. Common: 첫 10번의 피해가 확정 치명타.
3. Common: 치명타 피해량 +20%.
4. Common: 치명타 피해량 +50%.

Uncommon
5. Uncommon: 치명타 발생 시 치명타 확률 +5%(쿨다운 5초).
6. Uncommon: 빙결 상태인 적에게 치명타 확률 +30%.
7. Uncommon: 스테이지 시작 시 치명타 확률 +30%, 1초마다 1%씩 감소(0%까지).
8. Uncommon: 치명타 발생 시 30% 확률로 빙결 1 부여.
9. Uncommon: 피해 -10%, 치명타 피해 +50%.
10. Uncommon: 무기 - 수리검, 치명타마다 해당 투사체 관통 +1(투사체 스탯 증가).
11. Uncommon: 무기 - 해당 무기로 치명타가 발생할 때마다 치명타 확률 +1%(이번 스테이지 한정).
12. Uncommon: 빈 슬롯 하나당 치명타 확률 +3%.
13. Uncommon: 치명타가 발생할 때마다 랜덤한 블럭에 0.1배수 피해.

Rare
14. Rare: 투사체 최초 치명타 발생 시 관통 2 부여(1회만 발동).
15. Rare: 치명타 발생 시 50% 확률로 폭발.
16. Rare: 플레이 영역의 블럭 하나당 치명타 확률 +1%.
17. Rare: 보유한 돈 10$당 치명타 확률 +5%.
18. Rare: 무기 - 분열 저격총, 치명타 발생 시 분열(최대 3회).
...
Uncommon
3. Uncommon: 치명타 피해 배율 +100%.
4. Uncommon: 해당 무기의 첫 10번 피해가 확정 치명타.
5. Uncommon: 해당 무기의 치명타 확률만큼 피해 배율 증가.
6. Uncommon: 해당 무기의 치명타 확률 +40%, 치명타가 발생하지 않을 때마다 치명타 확률 -5%.
7. Uncommon: 5번 공격할 때마다 다음 공격 확정 치명타.
